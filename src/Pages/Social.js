...
function Nav(){
    ...
    return (
        <div id="socialbox">
                <div id="socialbutton"> 
                    <img src={socb} id="socbut1" onClick={()=>{showbox()}}/>
                    <img src={socb} style={{display:'none'}} id="socbut2" onClick={()=>{hidebox()}}/>
                </div>
                <div className="socialmedia">
                    <img src={lin} className="fbicon" onClick={()=>window.open('https://www.linkedin.com/in/balamurugan-r-470ba2267/')}/>
                    <img src={git} className="fbicon" onClick={()=>window.open('https://github.com/RBM05')}/>
                    <img src={insta} className="fbicon" onClick={()=>window.open('https://www.facebook.com/profile.php?id=100042306348708')}/>
                    <img src={fb} className="fbicon" onClick={()=>window.open('https://www.facebook.com/profile.php?id=100042306348708')}/>
                </div>
            </div>
    );
}
